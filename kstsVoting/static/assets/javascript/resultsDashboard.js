...
let boysPrefectsList = [
  boysData.schoolPrefects,
  boysData.compoundPrefects,
  boysData.diningHallPrefects,
  boysData.libraryPrefects,
  boysData.healthPrefects,
  boysData.protocolPrefects,
  boysData.prepPrefects,
  boysData.sportsPrefects,
  boysData.entertainmentPrefects,
];
const boysTitles = [
  "School Prefect (Boys)",
  "Compound Oversear (Boys)",
  "Dining Hall Prefect (Boys)",
  "Library Prefect (Boys)",
  "Health Prefect (Boys)",
  "Protocol Prefect (Boys)",
  "Prep Prefect (Boys)",
  "Sports Prefect (Boys)",
  "Entertainment Prefect (Boys)",
];

let girlsPrefectsList = [
  girlsData.schoolPrefects,
  girlsData.compoundPrefects,
  girlsData.diningHallPrefects,
  girlsData.libraryPrefects,
  girlsData.healthPrefects,
  girlsData.protocolPrefects,
  girlsData.prepPrefects,
  girlsData.sportsPrefects,
  girlsData.entertainmentPrefects,
];
const girlsTitles = [
  "School Prefect (Girls)",
  "Compound Oversear (Girls)",
  "Dining Hall Prefect (Girls)",
  "Library Prefect (Girls)",
  "Health Prefect (Girls)",
  "Protocol Prefect (Girls)",
  "Prep Prefect (Girls)",
  "Sports Prefect (Girls)",
  "Entertainment Prefect (Girls)",
];
